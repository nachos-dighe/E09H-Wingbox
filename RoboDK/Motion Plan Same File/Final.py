...
data = open('AE1222-2021-GROUP-E09H-CoordinateFile-PanelRootBottom.txt')
...
data = open('AE1222-2021-GROUP-E09H-CoordinateFile-PanelTipTop.txt')
...
data = open('AE1222-2021-GROUP-E09H-CoordinateFile-SidePanelRootLong.txt')
...
data = open('AE1222-2021-GROUP-E09H-CoordinateFile-SidePanelTipLong.txt')
...
data = open('AE1222-2021-GROUP-E09H-CoordinateFile-SidePanelTipShort.txt')
